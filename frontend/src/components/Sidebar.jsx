...
const MENU_ITEMS = [
    ...
    { text: "Receitas", path: "/income", icon: <ArrowUp size={20} /> },
    { text: "Despesas", path: "/expense", icon: <ArrowDown size={20} /> },
...
const Sidebar = ({ user, isCollapsed, setIsCollapsed}) => {
    ...
    useEffect(() => {
        document.body.style.overflowY = mobileOpen ? "hidden" : "auto";
        return () => {
    ...
    const renderMenuItem = ({ text, path, icon }) => {
        ...
        return (
            ...
            >
                ...
                >
                    <span className={isActive ? sidebarStyles.menuItem.active : sidebarStyles.menuItem.inactive}>
                        {icon}
                    </span>
                    {!isCollapsed && (
                        <motion.span
    ...
    return (
        <>
            <motion.div
                ...
                animate={{ opacity: 1, x: 0, width: isCollapsed ? 80 : 250 }}
                ...
                <div className={sidebarStyles.sidebarInner.base}>
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <polyline points={isCollapsed ? "9 18 15 12 9 6" : "15 17 9 12 15 6"}></polyline>
                            </svg>
                        </motion.div>
                    </button>
                    <div
